...
\begin{frame}
\begin{figure}[h!]
\includegraphics[scale=0.5]{svg-inkscape/dibujo4_svg-tex}
\end{figure}
\end{frame}

\begin{frame}
\begin{figure}[h!]
\includegraphics[scale=0.5]{svg-inkscape/dibujo2_svg-tex}
\end{figure}
\end{frame}
...
\begin{frame}
\begin{figure}[h!]
\includegraphics[scale=0.5]{svg-inkscape/dibujo3_svg-tex}
\end{figure}
\end{frame}
