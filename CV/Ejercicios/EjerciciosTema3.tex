...
Sean $C_1=\{0\to A_1\to B_1\to 0$, $C_2=\{0\to A_2\to B_2\}$ y $C_3=\{0\to A_3\to B_3\to 0\}$ complejos de cadenas inducidos por el diagrama. Entonces entonces podemos ver el diagrama como una sucesión exacta corta de complejos de cadenas
\[
...
DIAGRAMA QUE ME TIENE QUE PASAR JAVI (la sobreyectividad por composición y la inyecticidad porque se induce en el cociente)

Entonces, como la sucesión escinde, tomando dimensión $\dim(A^i)-\dim(\Ima{d^{i-1}})=\dim(A^i/\Ima{d^{i-1}})=\dim(H^i(A^ *))+\dim(\Ima{d^i})$. Entonces, sustituyendo 
\[
...
V_1\arrow[d,"f"]\arrow[r,"1\oplus f"] & V_1\oplus V_2\arrow[r, "f-1"] \arrow[d, "(g\circ f)\oplus 1"]& V_2 \arrow[d,"g"]\\
V_2\arrow[d]\arrow[r, "g\oplus 1"]& V_3\oplus V_2\arrow[d] \arrow[r, "1-g"]& V_3\arrow[d]\\
0 & 0 & 0 
\end{tikzcd}
\]

Se comprueba fácilmente que los cuadrados conmutan y que las filas son exactas (incluyendo la inyecticidad de la izquierda y la sobreyectividad de la derecha). De la sucesión de homología se obtiene el resultado.
\end{solucion}
