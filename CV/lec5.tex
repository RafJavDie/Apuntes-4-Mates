...
que por definición es $\alpha^*\partial^*([c])$. Obsérvese que la preimagen por $f^{p+1}$ de $d_B$ existe porque $f^*$ es morfismo de cadenas, y por tanto conmuta con el operador borde. 

En la situación de la proposición \ref{addendum} consideramos el diagrama
\[
\begin{tikzcd}
0\arrow[r] & \Omega^*(U)\arrow[r, "I^*"]\arrow[d,"R^*"] & \Omega^*(U_1)\oplus \Omega^*(U_2)\arrow[r, "J^*"]\arrow[d,"R"]& \Omega^*(U_1\cap U_2)\arrow[d,"-R_0^*"]\arrow[r] & 0\\
0\arrow[r] &  \Omega^*(U)\arrow[r, "I^*"] & \Omega^*(U_1)\oplus\Omega^*(U_2)\arrow[r, "J^*"] & \Omega^*(U_1\cap U_2)\arrow[r] & 0
\end{tikzcd}
\]
con $R(w_1,w_2)=(R_1^*w_1,R_2^*w_2)$. Esto nos da la ecuación \ref{conmuta} de la demostración de \ref{addendum}. 
