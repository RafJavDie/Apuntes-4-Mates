...
\end{tabular}
 \right)
\]
TENGO CIERTA DUDA DE SI ES PHI O ES LA PRIMERA RESTRICCIÓN A LA PARTE NEGATIVA DE RN
Además $|D_q\phi|\neq 0$ por ser $\phi$ difeomorfismo local. Obsérvese que, para $i>1$, $\dparcial{\phi_1}{x_i}=0$ VETE TÚ A SABER POR QUÉ. Por otro lado  $\dparcial{\phi_1}{x_1}>0$ porque $\phi$ preserva la orientación de $\R^n$, es decir, el lado superior del borde va al lado superior y lo mismo con el inferior, quedando fijo el borde. 
