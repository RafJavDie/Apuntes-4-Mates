...
Mediante esta relación de equivalencia, aparecen dos clases de equivalencia (si $n > 0$), que llamamos \index{orientación}\emph{orientaciones} sobre $\sigma$, que denotaremos por $\sigma$ y $\overline{\sigma}$.
...
\[ \partial([v_1,v_0,\dots,v_n]) = [v_1,v_2,\dots,v_n]-[v_0,v_2,\dots,v_n] + \sum_{i\neq0,1}(-1)^i[v_1,v_0,\dots,\widehat{v_i},\dots,v_n]\]
Los dos primeros términos están en el otro lado con símbolo cambiado.
Cada término del sumatorio aparece en el otro lado con símbolo cambiado.
...
De aquí podemos definir el $n$-ésimo espacio vectorial de homología simplicial de $K$ (complejo positivo):
