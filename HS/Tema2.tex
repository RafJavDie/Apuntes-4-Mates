...
\]
Como $f_*$ es isomorfismo, esto implica que $[z_1]=[0]$. Así que existe $c_1\in C_n$ tal que $-\partial_n(c_1)=z_1$. 
...
donde $p_1^{n+1}$ e $i_2^n$ provienen del diagrama de proyeccione e inclusiones siguiente:
\[
\begin{tikzcd}
...
\]
\end{itemize}
Para $g \circ f \simeq_h Id_{\CC}$, usaremos $h_n = -p_1^{n+2} \circ \overline{h}_{n+1} \circ i_1^n$.


Para $f \circ g \simeq_{h'} id_{\CC'}$, usaremos $h_n' = p_2^{n+1} \circ \overline{h}_n \circ i_2^n$.
\end{proof}
\end{document}