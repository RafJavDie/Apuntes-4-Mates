...
\item $S^1$.  
\item $S^1$ (se retrae sobre $\R^2\setminus\{0\}$ y luego a $S^1$). $S^2\vee T^2$ como se puede ver en la imagen. 
\begin{figure}[h!]
\includegraphics[scale=0.6]{S2wedgeT2}
\end{figure}  
\item $S^1$ y $S^1\vee S^1$.
\newpage
...
\item $S^1$. Podemos empujar el agujero hasta los bordes y luego pegar con las identificaciones, de modo que queda una circunferencia. 
