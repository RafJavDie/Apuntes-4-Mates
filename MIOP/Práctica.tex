...
\begin{tabular}{|c| c| c| c | c| c|}
\hline
$m$ & $x$ & $g(x,1)$ & $f(m-x,2)$ &  $f(m,1)$ & $x^* $ \\
\hline
$4$ & $1$ & $0.2$  & $0.25$  & $0.05$ & \\
\hline            
 & $2$    & $0.3$  &$0.2$ & $0.06$ &\\
\hline            
 & $3$    & $0.4$  &$0.12$ & $0.072$ &$\boxed{3}$\\
\hline
 & $4$ & $0.5$     & $0.06$ & $0.03$&\\
 \hline
\end{tabular}
\end{center}
La solución óptima se alcanza invirtiendo $3$ millones en la Etapa 1, $1$ millón en la Etapa 2 y $0$ millones en la Etapa 3.
\item[\textbf{b)}]
\end{itemize}
\end{solucion}
