...
\end{teorema}
\begin{dem}
Como $x^*$ es mínimo local y el único punto estacionario en un entorno suyo, podemos tomar $\rho>0$ tal que $\forall \mid 0<||x-x^*||<\rho$, entonces $f(x)>f(x^*)$. Definimos la función $$\phi
