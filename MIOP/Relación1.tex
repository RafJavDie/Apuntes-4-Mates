...
$f(t,k)=\max_{x_t\leq k,1000|x_t}\{g(t,x_t)+f(t+1,k-x_t)\}$ y $f(3,k)=\max_{d\leq k}\{g(3,x_3)\}=k$. La función $g$ representa la ganancia, es decir, el valor de la tabla en la posición $(t,x_t)$. 
\end{solucion}
\end{ejercicio}
