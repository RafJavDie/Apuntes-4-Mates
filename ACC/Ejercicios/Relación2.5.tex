...
\end{ejercicio}
\begin{solucion}
Sabemos que existe $f_1,\dotsc,f_s$ tales que $V=\V(f_1,\dotsc,f_n)$. Si $x\in\V(\I(V)))$. Entonces $x$ es raíz de los polinomios de $\I(V)$, que por definición son los polinomios tales que se anulan en $V$. En particular, $f_1,\dotsc,f_s$ son polinomios que anulan en $V$, luego $x$ es raíz de $f_1,\dotsc,f_s$, por lo que $x\in V$.

Recíprocamente, como $I=\gene{g_1,\dotsc,g_t} \subset \I(V)$, entonces $\V(\I(V))\subset \V(I) = V$.
\end{solucion}
