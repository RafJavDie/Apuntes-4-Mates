...
Como $α ≤ α+γ = β$, deducimos que $α ≤ β$. Para el recíproco, basta probar que existe $\gamma$ tal que $\alpha+\gamma=\beta$. Basta tomar $\gamma=\beta-\alpha\geq 0$. Entonces $\alpha+\gamma=\beta$. 
