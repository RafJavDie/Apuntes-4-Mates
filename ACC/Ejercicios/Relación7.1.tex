...
\]
Si denotamos $g\in k[t_1,t_2,t_3]$ al resto de dividir $f$ por $G$, sabemos que $g(\sigma_1,\sigma_2,\sigma_3)$ es la expresión que buscamos. Pero no me sale la división en SAGE.
\end{enumerate}
...
\item Cualquier combinación algebraica de elementos de $k$ está en $k$.
\end{enumerate}
