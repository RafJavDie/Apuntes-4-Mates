...
$$
Supongamos que para todo $n\leq s-1$ verifica la igualdad para todo $j$ y veamos qué ocurre para $n=s$. Si $j=1$ es trivial. Supongamos hipótesis de inducción para $j\leq n$.
\begin{align*}
