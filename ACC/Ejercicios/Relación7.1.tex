...
\item[]
\item
\item Para $j=1$ es caro, pues tenemos simplemente $\sigma_0 s_1 - s_1 = 0$. Supongamos que es cierto para $j=s-1$ y veamos que es cierto para $j=s$. De la hipótesis de inducción podemos deducir que
\begin{align*}
