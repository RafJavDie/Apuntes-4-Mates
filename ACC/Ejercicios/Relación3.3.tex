...
\item Tenemos que que $I_2 = \{v^2-z,x^2-yz\}$. Como el primer polinomio tiene coeficiente constante la mayor potencia de $v$, tenemos que por el Teorema de Extensión cualquier solución $(x,y,z)\in \V(I_2)$ se extiende a una solución $(u,x,y,z)\in \V(I_1)$. Análogamente, tenemos que los coeficientes líderes de las mayores potencais de $u$ definen la variedad
$$
