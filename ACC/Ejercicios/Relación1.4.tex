...
\begin{enumerate}[a.]
\item[]
\item Veamos que $V=\V(x^2-z,xz-y^2)$. Una inclusión es trivial, recíprocamente podemos suponer que $xyz\neq 0$, pues en otro caso se tendría $x=y=z=0$. Llamemos $t=y/x$. Entonces $t^2 = y^2/x^2 =xz/z = x$. Por tanto, $z=x^2=t^4$ e $y=tx=t^3$. Por tanto, se tiene la igualdad.
...
\item Como $k$ es cuerpo, dada una constanta $a$, podemos generar $1=aa^{-1}$, por lo que podemos aplicar el apartado anterior.
