...
y las operaciones de suma y producto definidas en ellos con las propiedades usuales. El conjunto $\Z$, dotado con las operaciones suales es un \textbf{anilo conmutativo}. El anillo $\Z$ es un \textbf{dominio de integridad}.
