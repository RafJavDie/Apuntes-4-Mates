...
\begin{itemize}
\item[]
\item Dado que $g(n) = f\ast \mu(n)$ y $\mu$ es una función multiplicativa, basta probar que $f$ también lo es para demostrar que $g$ lo es (propiedades de la convolución). PENDIENTE.
