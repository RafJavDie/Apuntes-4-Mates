...
En cuanto a la extensión, como $Γ(s)=Γ(s+1)/s$ y $Γ(s+1)/s$ es meromorfa en $\text{Re}(s)>-1$, entonces $Γ(s)$ es meromorfa en $\text{Re}(s)>-2$. Por inducción, $Γ(s)$ es meromorfa en todo el plano de manera que:
...
\begin{align*}
	Γ^2(1/2) & = \left(\int_0^{∞}t^{-1/2}e^{-t}dt\right)^2 = 4 \int_0^{∞}\int_0^{∞} e^{-(u^2+v^2)} dudv\\
	& = 4 \int_0^{π/2}\int_0^{∞} e^{-r^2}r dr dφ = 4 \frac{1}{2} \frac{π}{2} \int_0^{∞} e^{-x} dx = π
\end{align*}
Luego $Γ(1/2)=\sqrt{π}$. Por otro lado, supongamos que
