...
A continuación daremos la demostración rigurosa.
...
\begin{example}
\[ \min x_1+x_2+x_3\]
\[ s.a. x_1^2+4x_2^2+9x_3^2 ≤ 1 \]
\[ L(x,λ) = f(x)-λg(x) = x_1+x_2+x_3 - λ(x_1^2+4x_2^2+9x_3^2 - 1) \]
\[ \frac{\partial L}{\partial x} = \begin{pmatrix}1-2λx_1\\18λx_2\\1-18λx_3\end{pmatrix} \]
Por tanto $λ \neq 0$. Como $λg(x) = 0$, entonces $g(x) = 0$. Despejando:
...
Sustituyendo:
\[ λg(x) = \frac{1}{2λ}^2+4 \frac{1}{8λ}^2+9\frac{1}{18λ}^2 = 1 \Rightarrow λ = \pm \frac{42}{72} = \pm \frac{7}{12} \]
Elegimos el $λ < 0$, para minimizar $x$. Así pues, el mínimo es:
