...
\item La matriz resultante de multiplicar una fila o columna de A por $-1$ es RU.
...
\end{dem}
\begin{theorem}
$A\in\Z^{m\times n}$ es TI si y solo si $\forall J\subset\{1,\dotsc,n\}$ existe una partición de J en $J_1J_2$ tal que 
\[
...
sa:& \sum_{j=1}^n x_{ij}= 0 \quad\forall i =1,,m & \\
