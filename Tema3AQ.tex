...
\end{ejer}
\begin{solucion}
De la hipótesis sobre $Y$ obtenemos que $Y\simeq cte\ y_0$. Así pues, consideremos el siguiente esquema:
\[
\begin{tikzcd}
...
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
\clip(-0.48,2.3) rectangle (14,7.2);
\draw (-0.02,6.02)-- (1.24,6.02);
\draw (-0.02,6.16)-- (-0.02,5.84);
\draw (1.24,6.14)-- (1.24,5.84);
\draw [->] (0.76,5.8) -- (3.34,5.34);
\draw [rotate around={140.1083141857361:(4.042968635981152,4.440137725004447)}] (4.042968635981152,4.440137725004447) ellipse (2.3074690921917074cm and 1.5445008846026804cm);
\draw [rotate around={-48.205215931013484:(4.15,4.46)}] (4.15,4.46) ellipse (1.173868273222346cm and 0.7708869715321528cm);
\draw [->] (5.86,4.98) -- (8.98,4.98);
\draw [rotate around={91.86004162363376:(11.107247262161367,4.52706663812374)}] (11.107247262161367,4.52706663812374) ellipse (2.231420875857465cm and 1.8276067289151716cm);
\draw [rotate around={-81.20945681718591:(10.93,4.77)}] (10.93,4.77) ellipse (1.394983257588355cm and 0.9912508708454363cm);
\draw (1.5,6.38) node[anchor=north west] {$\alpha$};
\draw (5.04,3.84) node[anchor=north west] {$x_0$};
\draw (6.22,4.14) node[anchor=north west] {$X$};
\draw (11.66,3.96) node[anchor=north west] {$f(x_0)$};
\draw (9.1,3.78) node[anchor=north west] {$Y$};
\draw (7.28,5.7) node[anchor=north west] {$f$};
\begin{scriptsize}
\draw [fill=black] (5.04,3.72) circle (2.5pt);
\draw [fill=black] (11.74,3.84) circle (2.5pt);
\end{scriptsize}
\end{tikzpicture}
...
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
\clip(-4.12,1) rectangle (10,5);
\draw [rotate around={170.2986841352012:(-1.808419180601154,2.3370463354672495)}] (-1.808419180601154,2.3370463354672495) ellipse (1.546161365316914cm and 0.7067851496362759cm);
\draw [rotate around={168.42616123282588:(-1.735956765520892,4.141236264461723)}] (-1.735956765520892,4.141236264461723) ellipse (1.521223288419804cm and 0.6527505927873694cm);
\draw [line width=2.pt,] (-3.230799274883972,4.362591177553881)-- (-3.3237142581530685,2.6351728732653554);
\draw (-0.27982787431338485,2.14000432111255)-- (-0.23999038805387474,3.8995688334066037);
\draw [->] (-1.32,4.36) -- (3.2,3.38);
\draw [->] (-0.56,2.92) -- (3.06,2.62);
\draw [->] (-0.44,1.6) -- (3.12,1.9);
\draw [rotate around={0.:(4.76,2.76)}] (4.76,2.76) ellipse (1.7929191709975851cm and 1.1683146638344746cm);
\draw [line width=1.6pt] (3.76,2.74)--  (3.76,2.74)-- (3.8,2.8)-- (3.84,2.86)-- (3.9,2.9)-- (3.96,2.94)-- (4.02,2.96)-- (4.08,2.98)-- (4.16,2.98)-- (4.24,2.98)-- (4.34,2.98)-- (4.42,2.98)-- (4.5,2.94)-- (4.56,2.92)-- (4.62,2.9)-- (4.68,2.88)-- (4.74,2.84)-- (4.8,2.82)-- (4.86,2.78)-- (4.92,2.76)-- (4.98,2.74)-- (5.04,2.76)-- (5.08,2.82)-- (5.14,2.84);
\draw (-3.74,4.8) node[anchor=north west] {$x_0$};
\draw (-3.6,2.5) node[anchor=north west] {$1$};
\draw (-2.18,2.3) node[anchor=north west] {$X$};
\draw (-3.74,3.7) node[anchor=north west] {$\gamma$};
\draw (0.78,2.2) node[anchor=north west] {$g\circ f$};
\draw (1.16,3.2) node[anchor=north west] {$H$};
\draw (1.34,4.3) node[anchor=north west] {$Id$};
\draw (3.44,2.7) node[anchor=north west] {$x_0$};
\draw (5.16,3) node[anchor=north west] {$g(f(x_0))$};
\draw (4.26,3.4) node[anchor=north west] {$\gamma$};
\begin{scriptsize}
\draw [fill=black] (3.76,2.74) circle (2.5pt);
\draw [fill=black] (5.14,2.84) circle (2.5pt);
\end{scriptsize}
\end{tikzpicture}
...
\begin{prop}
Sea $H$ una homotopía $H\func{X\times I}{Y}$ entre $f,g\func{X}{Y}$. Dado $x_0\in X$, sea $\gamma\func{I}{X}$ el camino $\gamma(t)=H(x_0,t)$. Este camino va de $f(x_0)=H(x_0,0)$ a $g(x_0)=H(x_0,1)$. Tenemos el diagrama commutativo
\[
\begin{tikzcd}
\pi_1(X,x_0)\arrow[d,"g_*"] \arrow[r, "f_*"] &  \pi_1(Y,f(x_0))\arrow[dl,"\cong"',"\gamma_\sharp"] \\
\pi_1(Y,g(x_0))\arrow[ur, dashrightarrow,"\overline{\gamma}_\sharp"', bend right=30]  %, bend right=30
\end{tikzcd}
\]
\end{prop}
