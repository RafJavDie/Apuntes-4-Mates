...
\begin{defi}Sean $x\in B\subseteq X$. Diremos que $x$ es \textbf{punto interior} de $B$ si $\exists U\in\Tau$ tal que $x\in U\subseteq B$. Diremos que es \textbf{adherente} a $B$ si para todo $U\in\Tau$ con $x\in U$, $U\cap B\neq\emptyset$.
\end{defi}
...
\end{defi}
\begin{prop}Conexo por caminos implica conexo.
\end{prop}
\begin{defi}Dado un subconjunto $A\subseteq X$ conexo por caminos diremos que $x\in A$ es un \textbf{punto de corte} si $A\setminus\{x\}$ no es conexo por caminos.
\end{defi}
