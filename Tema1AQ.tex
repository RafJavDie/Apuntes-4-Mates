...
\begin{enumerate}
\item[a)] Por la proposición \ref{125} deducimos que f es cerrada y, por la proposición anterior y el hecho de que $\mathcal{R}_f$ es compatible con $f$, deducimos que $\tilde{f}$ continua.
