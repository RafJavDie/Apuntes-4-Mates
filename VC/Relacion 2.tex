...
\end{ejercicio}
\begin{solucion}
Por el Teorema de Ronge, tenemos que podemos aproximar una función en un entorno de $K$ uniformemente por funciones racionales con polos en $\C\setminus K$.
$$
R(x)
$$
\end{solucion}
...
$$
Como $K$ es compacto, sabemos que existe existe una cantidad finita de $V_i$ que lo recubren. Podemos considerar el compacto conexo
$$
S= \bigcup_{i=1}^s V_{n_i}
$$
y aplicar el Teorema de Rounge.
\end{solucion}
\newpage
