...
\begin{enumerate}[(a)]
\item[]
\item Es claro que para cada $r>0$, $|z|\leq r$, $F_n(z)=1-z/\rho^n$ verifica 
$$
|F_n(z)-1| = |z|/\rho^n \leq r/\rho^n \qquad \sum_{n=0}^\infty r/\rho^n = r \frac{\rho}{\rho-1}
$$
...
%$$
%\abs{\prod_{n=0}^\infty \left(1-\frac{z}{\rho^n}\right)} = \prod_{n=0}^\infty \prod_{n=0}^\infty \abs{1-\frac{z}{\rho^n}} \leq \prod_{n=0}^\infty \left(1+\frac{|z|}{\rho^n}\right) \leq e^{|z|\sum_n \rho^{-n}} = e^{|z|\rho(\rho-1)^{-1}}
%$$
\item Es claro que 
$$
