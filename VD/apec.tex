...
\addcontentsline{toc}{chapter}{Ap\'{e}ndice C. \'{A}lgebras Tensorial y Exterior de un Espacio Vectorial.}
\section*{C.1 \'{A}lgebra Tensorial de un Espacio Vectorial.}
\addcontentsline{toc}{section}{C.1\hspace{0.5 em} \'{A}lgebra Tensorial de un Espacio Vectorial.} \hs En este ap\'{e}ndice
...
\addcontentsline{toc}{section}{C.2\hspace{0.5 em} \'{A}lgebra Exterior de un Espacio Vectorial.} \hs Sean $r\in\N$ y
