...
\addcontentsline{toc}{chapter}{Apéndice B. Teorema de la Función Implícita.}
\section*{B.1 Teorema de la Función Implícita.}
\addcontentsline{toc}{section}{B.1\hspace{0.5 em} Teorema de la Función Implícita.}
\begin{teoap}
...
\addcontentsline{toc}{section}{A.3\hspace{0.5 em} Lema de Poincaré.}
\begin{teoap}
