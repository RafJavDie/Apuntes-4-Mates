...
\item[(c)] Como contraejemplo de que no es cierto en general podemos usar $X=\{1,2\}$ con la topología $T=\{\emptyset,X\}$. Tomando $A=B=\{1\}$, tenemos que $A \in T|_B = \{\emptyset,A\}$, pero $A \notin T$.
